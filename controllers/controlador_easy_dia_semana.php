...
class controlador_easy_dia_semana extends system {

    public controlador_easy_dia_semana $controlador_easy_horario;
    public string $link_easy_horario_alta_bd = '';

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new easy_dia_semana(link: $link);
        $html_ = new easy_dia_semana_html(html: $html);
