...
use html\easy_status_cita_html;
use PDO;
use stdClass;

class controlador_easy_status_cita extends system {

    public controlador_easy_status_cita $controlador_easy_horario;
    public string $link_easy_horario_alta_bd = '';

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new easy_status_cita(link: $link);
        $html_ = new easy_status_cita_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Status Cita';
        $this->titulo_lista = 'Status Cita';
