...
use html\easy_servicio_html;
use PDO;
use stdClass;

class controlador_easy_servicio extends system {

    public controlador_easy_servicio $controlador_easy_cita;
    public string $link_easy_horario_alta_bd = '';

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new easy_servicio(link: $link);
