...
class controlador_easy_cita_servicio extends system {

    public controlador_easy_cita_servicio $controlador_easy_horario;
    ...
    {
        $this->seccion_titulo = 'Cita Servicio';
        $this->titulo_lista = 'Cita Servicio';
